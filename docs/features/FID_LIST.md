...
| 15 | [FID-ERP-015](FID-ERP-015_20260920.md) | Kết quả tìm kiếm BẤM ĐƯỢC + trang chi tiết Traveler/PS/Part# | Cả 3 điểm truy cập | — (MỚI — Andy 2026-09-20: "khi search ra thì có thể click vào link") | **✅ DONE — code xong (2026-09-20)** | Bấm Traveler ở trang có ô Traveler# (Xưởng/Wrapping/Packing/Lot) → tự điền + Tra (sự kiện `avp:pick-traveler`); trang khác → `/view/traveler/<no>` (lịch sử RECEIVE→SHIP, Good/Hold, đổi Lot, PS). PS → `/view/ps`, Part# → `/view/part`. Chỉ đọc, mọi trạm |
